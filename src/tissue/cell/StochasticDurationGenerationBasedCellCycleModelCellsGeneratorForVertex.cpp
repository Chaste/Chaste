...
template<unsigned DIM>
double StochasticDurationGenerationBasedCellCycleModelCellsGeneratorForVertex<DIM>::GetTypicalTransitCellCycleTime()
{
...
template<unsigned DIM>
double StochasticDurationGenerationBasedCellCycleModelCellsGeneratorForVertex<DIM>::GetTypicalStemCellCycleTime()
{
...
template<unsigned DIM>
bool StochasticDurationGenerationBasedCellCycleModelCellsGeneratorForVertex<DIM>::CellsCanDifferentiate()
{
    return true;
}
...
template<unsigned DIM>
void StochasticDurationGenerationBasedCellCycleModelCellsGeneratorForVertex<DIM>::GenerateForVertexCrypt(std::vector<TissueCell>& rCells,
...
//template class StochasticDurationGenerationBasedCellCycleModelCellsGeneratorForVertex<1>;
template class StochasticDurationGenerationBasedCellCycleModelCellsGeneratorForVertex<2>;
//template class StochasticDurationGenerationBasedCellCycleModelCellsGeneratorForVertex<3>;
