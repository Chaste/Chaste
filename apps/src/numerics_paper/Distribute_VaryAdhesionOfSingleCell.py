...
def combine_output():
    ...
    combined_results.write("global_const,local_const,kick,change_in_centroid,change_in_top,change_in_bottom\n")
...
def plot_results():
    ...
    col_to_plot = 3 # the column to plot from the data file
