...
#ifdef _MSC_VER
#else
 /*This gave me a whole lot of grief with Windows SDK*/
 #define VOID int
#endif
/*Windows_Port_Begins*/
...
#include <WinSock2.h>
#include <windows.h>
//The portion below is adapted from http://www.suacommunity.com/dictionary/gettimeofday-entry.php
...

{
  ...
  struct otri botlcasing, botrcasing;
  struct otri toplcasing={nullptr, 0}, toprcasing={nullptr, 0};
  struct otri testtri;
  struct osub botlsubseg, botrsubseg;
  struct osub toplsubseg, toprsubseg;
