...
class VertexT1SwapLocationsWriter3_3_Overrides : public VertexT1SwapLocationsWriter3_3{
    public:
...
py::class_<VertexT1SwapLocationsWriter3_3 , VertexT1SwapLocationsWriter3_3_Overrides , boost::shared_ptr<VertexT1SwapLocationsWriter3_3 >  , AbstractCellPopulationWriter<3, 3>  >(m, "VertexT1SwapLocationsWriter3_3")
        .def(py::init< >())
        .def(
            "Visit",
            (void(VertexT1SwapLocationsWriter3_3::*)(::MeshBasedCellPopulation<3> *)) &VertexT1SwapLocationsWriter3_3::Visit,
