...
class AbstractCellPopulationCountWriter3_3_Overrides : public AbstractCellPopulationCountWriter3_3{
    public:
...
py::class_<AbstractCellPopulationCountWriter3_3 , AbstractCellPopulationCountWriter3_3_Overrides , boost::shared_ptr<AbstractCellPopulationCountWriter3_3 >  , AbstractCellBasedWriter<3, 3>  >(m, "AbstractCellPopulationCountWriter3_3")
        .def(py::init<::std::string const & >(), py::arg("rFileName"))
        .def(
            "WriteHeader",
            (void(AbstractCellPopulationCountWriter3_3::*)(::AbstractCellPopulation<3> *)) &AbstractCellPopulationCountWriter3_3::WriteHeader,
            " " , py::arg("pCellPopulation") )
        .def(
            "Visit",
            (void(AbstractCellPopulationCountWriter3_3::*)(::MeshBasedCellPopulation<3> *)) &AbstractCellPopulationCountWriter3_3::Visit,
            " " , py::arg("pCellPopulation") )
        .def(
            "Visit",
