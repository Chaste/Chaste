...
class MeshBasedCellPopulation3_3_Overrides : public MeshBasedCellPopulation3_3{
    public:
...
py::class_<MeshBasedCellPopulation3_3 , MeshBasedCellPopulation3_3_Overrides , boost::shared_ptr<MeshBasedCellPopulation3_3 >  , AbstractCentreBasedCellPopulation<3, 3>  >(m, "MeshBasedCellPopulation3_3")
        ...
        .def(
            "AcceptPopulationEventWriter",
            (void(MeshBasedCellPopulation3_3::*)(::boost::shared_ptr<AbstractCellPopulationEventWriter<3, 3>>)) &MeshBasedCellPopulation3_3::AcceptPopulationEventWriter,
        ...
        .def(
            "SpringsBegin",
            (::MeshBasedCellPopulation<3>::SpringIterator(MeshBasedCellPopulation3_3::*)()) &MeshBasedCellPopulation3_3::SpringsBegin,
            " "  )
        .def(
            "SpringsEnd",
            (::MeshBasedCellPopulation<3>::SpringIterator(MeshBasedCellPopulation3_3::*)()) &MeshBasedCellPopulation3_3::SpringsEnd,
            " "  )
        .def(
            "CheckCellPointers",
        ...
        .def(
            ...
            (void(MeshBasedCellPopulation3_3::*)(bool)) &MeshBasedCellPopulation3_3::SetBoundVoronoiTessellation,
            " " , py::arg("boundVoronoiTessellation") )
        .def(
            "GetBoundVoronoiTessellation",
            (bool(MeshBasedCellPopulation3_3::*)()) &MeshBasedCellPopulation3_3::GetBoundVoronoiTessellation,
            " "  )
        .def(
            "GetNeighbouringNodeIndices",
            (::std::set<unsigned int>(MeshBasedCellPopulation3_3::*)(unsigned int)) &MeshBasedCellPopulation3_3::GetNeighbouringNodeIndices,
            " " , py::arg("index") )
        .def(
