...
class VertexT2SwapLocationsWriter3_3_Overrides : public VertexT2SwapLocationsWriter3_3{
    public:
...
py::class_<VertexT2SwapLocationsWriter3_3 , VertexT2SwapLocationsWriter3_3_Overrides , boost::shared_ptr<VertexT2SwapLocationsWriter3_3 >  , AbstractCellPopulationWriter<3, 3>  >(m, "VertexT2SwapLocationsWriter3_3")
        .def(py::init< >())
        .def(
            "Visit",
            (void(VertexT2SwapLocationsWriter3_3::*)(::MeshBasedCellPopulation<3> *)) &VertexT2SwapLocationsWriter3_3::Visit,
