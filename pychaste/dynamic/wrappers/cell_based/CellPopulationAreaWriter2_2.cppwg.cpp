...
class CellPopulationAreaWriter2_2_Overrides : public CellPopulationAreaWriter2_2{
    public:
...
py::class_<CellPopulationAreaWriter2_2 , CellPopulationAreaWriter2_2_Overrides , boost::shared_ptr<CellPopulationAreaWriter2_2 >  , AbstractCellPopulationWriter<2, 2>  >(m, "CellPopulationAreaWriter2_2")
        .def(py::init< >())
        .def(
            "Visit",
            (void(CellPopulationAreaWriter2_2::*)(::MeshBasedCellPopulation<2> *)) &CellPopulationAreaWriter2_2::Visit,
