...
class CellsGeneratorBernoulliTrialCellCycleModel_3_Overrides : CellsGeneratorBernoulliTrialCellCycleModel_3{
    public:
...
py::class_<CellsGeneratorBernoulliTrialCellCycleModel_3  , boost::shared_ptr<CellsGeneratorBernoulliTrialCellCycleModel_3 >   >(m, "CellsGeneratorBernoulliTrialCellCycleModel_3")
        ...
        .def("GenerateBasic",
            ...
            &CellsGeneratorBernoulliTrialCellCycleModel_3_Overrides::GenerateBasic, " " , py::arg("numCells"),  py::arg("locationIndices") = std::vector<unsigned int>(), py::arg("pCellProliferativeType") = boost::shared_ptr<AbstractCellProperty>())
        .def("GenerateBasicRandom",
            ...
            &CellsGeneratorBernoulliTrialCellCycleModel_3_Overrides::GenerateBasicRandom, " " , py::arg("numCells"), py::arg("pCellProliferativeType") = boost::shared_ptr<AbstractCellProperty>())
        .def("GenerateGivenLocationIndices",
            ...
            &CellsGeneratorBernoulliTrialCellCycleModel_3_Overrides::GenerateGivenLocationIndices, " " , py::arg("locationIndices"), py::arg("pCellProliferativeType") = boost::shared_ptr<AbstractCellProperty>())
    ;
}
