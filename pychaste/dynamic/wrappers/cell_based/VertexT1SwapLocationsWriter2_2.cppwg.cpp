...
class VertexT1SwapLocationsWriter2_2_Overrides : public VertexT1SwapLocationsWriter2_2{
    public:
...
py::class_<VertexT1SwapLocationsWriter2_2 , VertexT1SwapLocationsWriter2_2_Overrides , boost::shared_ptr<VertexT1SwapLocationsWriter2_2 >  , AbstractCellPopulationWriter<2, 2>  >(m, "VertexT1SwapLocationsWriter2_2")
        .def(py::init< >())
        .def(
            "Visit",
            (void(VertexT1SwapLocationsWriter2_2::*)(::MeshBasedCellPopulation<2> *)) &VertexT1SwapLocationsWriter2_2::Visit,
