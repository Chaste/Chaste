...
class CellDivisionLocationsWriter3_3_Overrides : public CellDivisionLocationsWriter3_3{
    public:
...
py::class_<CellDivisionLocationsWriter3_3 , CellDivisionLocationsWriter3_3_Overrides , boost::shared_ptr<CellDivisionLocationsWriter3_3 >  , AbstractCellPopulationEventWriter<3, 3>  >(m, "CellDivisionLocationsWriter3_3")
        .def(py::init< >())
        .def(
            "VisitAnyPopulation",
            (void(CellDivisionLocationsWriter3_3::*)(::AbstractCellPopulation<3> *)) &CellDivisionLocationsWriter3_3::VisitAnyPopulation,
            " " , py::arg("pCellPopulation") )
        .def(
            "Visit",
            (void(CellDivisionLocationsWriter3_3::*)(::MeshBasedCellPopulation<3> *)) &CellDivisionLocationsWriter3_3::Visit,
            " " , py::arg("pCellPopulation") )
        .def(
            "Visit",
