...
class CellsGeneratorUniformG1GenerationalCellCycleModel_3_Overrides : CellsGeneratorUniformG1GenerationalCellCycleModel_3{
    public:
...
py::class_<CellsGeneratorUniformG1GenerationalCellCycleModel_3  , boost::shared_ptr<CellsGeneratorUniformG1GenerationalCellCycleModel_3 >   >(m, "CellsGeneratorUniformG1GenerationalCellCycleModel_3")
        ...
        .def("GenerateBasic",
            ...
            &CellsGeneratorUniformG1GenerationalCellCycleModel_3_Overrides::GenerateBasic, " " , py::arg("numCells"),  py::arg("locationIndices") = std::vector<unsigned int>(), py::arg("pCellProliferativeType") = boost::shared_ptr<AbstractCellProperty>())
        .def("GenerateBasicRandom",
            ...
            &CellsGeneratorUniformG1GenerationalCellCycleModel_3_Overrides::GenerateBasicRandom, " " , py::arg("numCells"), py::arg("pCellProliferativeType") = boost::shared_ptr<AbstractCellProperty>())
        .def("GenerateGivenLocationIndices",
            ...
            &CellsGeneratorUniformG1GenerationalCellCycleModel_3_Overrides::GenerateGivenLocationIndices, " " , py::arg("locationIndices"), py::arg("pCellProliferativeType") = boost::shared_ptr<AbstractCellProperty>())
    ;
}
