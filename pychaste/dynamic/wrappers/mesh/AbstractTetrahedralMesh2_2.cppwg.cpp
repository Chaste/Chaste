...
class AbstractTetrahedralMesh2_2_Overrides : public AbstractTetrahedralMesh2_2{
    public:
...
py::class_<AbstractTetrahedralMesh2_2 , AbstractTetrahedralMesh2_2_Overrides , boost::shared_ptr<AbstractTetrahedralMesh2_2 >  , AbstractMesh<2, 2>  >(m, "AbstractTetrahedralMesh2_2")
        .def(
