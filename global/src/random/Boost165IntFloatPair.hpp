 ...
 *
 * Minimal changes were made to the file to include it here, simply giving the functions a unique name
 * by appending _v165 so that later boosts don't have an incompatibility if this file is lying around.
 *
 */
