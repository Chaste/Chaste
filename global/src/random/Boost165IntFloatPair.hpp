...
#ifndef BOOST_165_RANDOM_DETAIL_INT_FLOAT_PAIR_HPP
#define BOOST_165_RANDOM_DETAIL_INT_FLOAT_PAIR_HPP
...
namespace random
{
    namespace detail
    {
        ...
        std::pair<RealType, int> generate_int_float_pair_v165(Engine& eng, boost::mpl::true_)
        {
            ...
            {
                base_unsigned u = generate_one_digit_v165(eng, m);
                bucket = (bucket << m) | u;
            }
            RealType r;
        ...
        template <class RealType, std::size_t w, class Engine>
        inline std::pair<RealType, int> generate_int_float_pair_v165(Engine& eng, boost::mpl::false_)
        {
...
#endif // BOOST_165_RANDOM_DETAIL_INT_FLOAT_PAIR_HPP
