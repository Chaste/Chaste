 ...
 *
 * This file is provided to users of Boost up to 1.63 and gives forward compatibility with
 * Boost 1.64 and beyond. (An optimisation in exponential distribution that this class
 * uses was implemented in version 1.64)
 *
 * Local changes made:
 *
 * - (This comment-block added and escaped from Doxygen checking)
 *
 * - #define BOOST_RANDOM_NORMAL_DISTRIBUTION_HPP renamed BOOST_165_RANDOM_NORMAL_DISTRIBUTION_HPP
