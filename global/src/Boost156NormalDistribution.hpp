 ...
 *
 * This file is provided to users of Boost up to 1.55 and gives forward compatibility with
 * Boost 1.56 and beyond.  (A bug in normal distributions was discovered and fixed in version 1.56
 *
 * Local changes made:
 *
 ...
 * now referred to as boost::exponential_distribution since this namespace works on more versions --- back to 1.40
 *
 * THIS FILE IS NOT (YET?) COMPATIBLE WITH BOOST 1.37
 *
 */
...
public:
     ...
     * Requires: sigma >= 0
     */
    explicit normal_distribution_v156(const RealType& mean_arg = RealType(0.0),
