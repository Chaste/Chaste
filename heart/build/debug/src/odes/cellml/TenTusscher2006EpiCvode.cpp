...
#include "MathsCustomFunctions.hpp"
    ...
    double CellTenTusscher2006EpiFromCellMLCvode::GetIIonic(const std::vector<double>* pStateVariables)
    {
        ...
        const double var_reversal_potentials__E_Ca = 0.5 * var_membrane__R * var_membrane__T * log(NV_Ith_S(mParameters, 3) / var_chaste_interface__calcium_dynamics__Ca_i) / var_membrane__F; // millivolt
        ...
        const double var_reversal_potentials__E_K = var_membrane__R * var_membrane__T * log(NV_Ith_S(mParameters, 4) / var_chaste_interface__potassium_dynamics__K_i) / var_membrane__F; // millivolt
        ...
        const double var_reversal_potentials__E_Ks = var_membrane__R * var_membrane__T * log((var_reversal_potentials__P_kna * NV_Ith_S(mParameters, 5) + NV_Ith_S(mParameters, 4)) / (var_reversal_potentials__P_kna * var_chaste_interface__sodium_dynamics__Na_i + var_chaste_interface__potassium_dynamics__K_i)) / var_membrane__F; // millivolt
        const double var_reversal_potentials__E_Na = var_membrane__R * var_membrane__T * log(NV_Ith_S(mParameters, 5) / var_chaste_interface__sodium_dynamics__Na_i) / var_membrane__F; // millivolt
        ...
        const double var_slow_time_dependent_potassium_current__i_Ks = pow(var_chaste_interface__slow_time_dependent_potassium_current_Xs_gate__Xs, 2) * (-var_reversal_potentials__E_Ks + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 1) * var_slow_time_dependent_potassium_current__g_Ks; // picoA_per_picoF
        ...
        const double var_sodium_potassium_pump_current__i_NaK = NV_Ith_S(mParameters, 4) * var_chaste_interface__sodium_dynamics__Na_i * var_sodium_potassium_pump_current__P_NaK / ((NV_Ith_S(mParameters, 4) + var_sodium_potassium_pump_current__K_mk) * (var_chaste_interface__sodium_dynamics__Na_i + var_sodium_potassium_pump_current__K_mNa) * (1.0 + 0.035299999999999998 * exp(-var_membrane__F * var_chaste_interface__membrane__V / (var_membrane__R * var_membrane__T)) + 0.1245 * exp(-0.10000000000000001 * var_membrane__F * var_chaste_interface__membrane__V / (var_membrane__R * var_membrane__T)))); // picoA_per_picoF
        const double var_transient_outward_current__g_to = 0.29399999999999998; // nanoS_per_picoF
        const double var_transient_outward_current__i_to = (-var_reversal_potentials__E_K + var_chaste_interface__membrane__V) * NV_Ith_S(mParameters, 2) * var_transient_outward_current__g_to * var_chaste_interface__transient_outward_current_r_gate__r * var_chaste_interface__transient_outward_current_s_gate__s; // picoA_per_picoF
    ...
    void CellTenTusscher2006EpiFromCellMLCvode::EvaluateYDerivatives(double var_chaste_interface__environment__time, const N_Vector rY, N_Vector rDY)
    {
        ...
        const double var_sodium_background_current__i_b_Na = (-var_reversal_potentials__E_Na + var_chaste_interface__membrane__V) * var_sodium_background_current__g_bna; // picoA_per_picoF
        const double var_sodium_calcium_exchanger_current__i_NaCa = (pow(var_chaste_interface__sodium_dynamics__Na_i, 3) * NV_Ith_S(mParameters, 3) * exp(var_membrane__F * var_chaste_interface__membrane__V * var_sodium_calcium_exchanger_current__gamma / (var_membrane__R * var_membrane__T)) - pow(NV_Ith_S(mParameters, 5), 3) * var_chaste_interface__calcium_dynamics__Ca_i * var_sodium_calcium_exchanger_current__alpha * exp((-1.0 + var_sodium_calcium_exchanger_current__gamma) * var_membrane__F * var_chaste_interface__membrane__V / (var_membrane__R * var_membrane__T))) * var_sodium_calcium_exchanger_current__K_NaCa / ((1.0 + var_sodium_calcium_exchanger_current__K_sat * exp((-1.0 + var_sodium_calcium_exchanger_current__gamma) * var_membrane__F * var_chaste_interface__membrane__V / (var_membrane__R * var_membrane__T))) * (pow(var_sodium_calcium_exchanger_current__Km_Nai, 3) + pow(NV_Ith_S(mParameters, 5), 3)) * (NV_Ith_S(mParameters, 3) + var_sodium_calcium_exchanger_current__Km_Ca)); // picoA_per_picoF
        const double d_dt_chaste_interface_var_calcium_dynamics__Ca_i = ((-var_calcium_dynamics__i_up + var_calcium_dynamics__i_leak) * var_calcium_dynamics__V_sr / var_membrane__V_c - 0.5 * (-2.0 * var_sodium_calcium_exchanger_current__i_NaCa + var_calcium_background_current__i_b_Ca + var_calcium_pump_current__i_p_Ca) * NV_Ith_S(mParameters, 6) / (var_membrane__F * var_membrane__V_c) + var_calcium_dynamics__i_xfer) * var_calcium_dynamics__Ca_i_bufc; // millimolar / millisecond
        const double var_sodium_potassium_pump_current__K_mNa = 40.0; // millimolar
        const double var_sodium_potassium_pump_current__K_mk = 1.0; // millimolar
        const double var_sodium_potassium_pump_current__P_NaK = 2.7240000000000002; // picoA_per_picoF
        const double var_sodium_potassium_pump_current__i_NaK = NV_Ith_S(mParameters, 4) * var_chaste_interface__sodium_dynamics__Na_i * var_sodium_potassium_pump_current__P_NaK / ((NV_Ith_S(mParameters, 4) + var_sodium_potassium_pump_current__K_mk) * (var_chaste_interface__sodium_dynamics__Na_i + var_sodium_potassium_pump_current__K_mNa) * (1.0 + 0.035299999999999998 * exp(-var_membrane__F * var_chaste_interface__membrane__V / (var_membrane__R * var_membrane__T)) + 0.1245 * exp(-0.10000000000000001 * var_membrane__F * var_chaste_interface__membrane__V / (var_membrane__R * var_membrane__T)))); // picoA_per_picoF
        const double d_dt_chaste_interface_var_sodium_dynamics__Na_i = (-var_fast_sodium_current__i_Na - var_sodium_background_current__i_b_Na - 3.0 * var_sodium_calcium_exchanger_current__i_NaCa - 3.0 * var_sodium_potassium_pump_current__i_NaK) * NV_Ith_S(mParameters, 6) / (var_membrane__F * var_membrane__V_c); // millimolar / millisecond
        const double var_transient_outward_current__g_to = 0.29399999999999998; // nanoS_per_picoF
    ...
    void CellTenTusscher2006EpiFromCellMLCvode::EvaluateAnalyticJacobian(double var_chaste_interface__environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        // Units: millivolt; Initial value: -85.23
        double var_chaste_interface__calcium_dynamics__Ca_i = NV_Ith_S(rY, 1);
        ...
        const double var_x163 = ((var_x158) ? (0.057000000000000002 * var_x157) : (0));
        const double var_x164 = ((var_x158) ? (310000.0 * var_x159 + 2.7000000000000002 * var_x160) : (5.9230769230769234 / var_x162));
        ...
        const double var_x170 = exp(-3.2000000000000002 - var_x13);
        ...
        const double var_x179 = -25428.0 * var_x177 - 6.9480000000000002e-6 * var_x178;
        const double var_x180 = var_x176 * var_x179;
        const double var_x181 = 37.780000000000001 + var_chaste_interface__membrane__V;
        const double var_x182 = ((var_x158) ? (0.024240000000000001 * var_x169) : (0.59999999999999998 * var_x173));
        const double var_x183 = ((var_x158) ? (var_x180 * var_x181) : (0));
        const double var_x184 = exp(2.5 + var_x120);
        ...
        const double var_x194 = exp(-1.0666666666666667 - 0.13333333333333333 * var_chaste_interface__membrane__V);
        const double var_x195 = 1.0 + var_x194;
        const double var_x196 = 1 / (var_x186 + 1.3999999999999999 * var_x193);
        const double var_x197 = exp(3.0 + var_x108);
        const double var_x198 = 1.0 + var_x197;
        const double var_x199 = 1 / var_x198;
        const double var_x200 = exp(1.3 + var_x109);
        ...
        const double var_x221 = var_chaste_interface__calcium_dynamics__Ca_ss / pow((0.0025000000000000005 + var_x218), 2);
        const double var_x222 = exp(-4.0 + var_x140);
        ...
        const double var_x238 = pow(var_chaste_interface__calcium_dynamics__Ca_SR, (-2));
        const double var_x239 = 1 / (1.0 + 2.25 * var_x238);
        const double var_x240 = 1 / (2.5 - 1.5 * var_x239);
        const double var_x241 = var_x218 * var_x240;
        const double var_x242 = 1 / (0.059999999999999998 + 0.14999999999999999 * var_x241);
        const double var_x243 = var_x242 * var_chaste_interface__calcium_dynamics__R_prime;
        const double var_x244 = var_x241 * var_x243;
        const double var_x245 = 0.015299999999999998 * var_x244;
        const double var_x246 = 1 / (pow((0.44444444444444442 + var_x238), 2) * pow(var_chaste_interface__calcium_dynamics__Ca_SR, 3));
        const double var_x247 = -var_chaste_interface__calcium_dynamics__Ca_ss + var_chaste_interface__calcium_dynamics__Ca_SR;
        const double var_x248 = var_x247 / pow((1 - 0.59999999999999998 * var_x239), 2);
        const double var_x249 = var_x218 * var_x243 * var_x246 * var_x248;
        const double var_x250 = var_x246 * var_chaste_interface__calcium_dynamics__R_prime;
        const double var_x251 = var_x248 / pow((0.40000000000000002 + var_x241), 2);
        const double var_x252 = var_x240 * var_x250 * var_x251 * pow(var_chaste_interface__calcium_dynamics__Ca_ss, 4);
        const double var_x253 = var_x251 * pow(var_chaste_interface__calcium_dynamics__Ca_ss, 3) * var_chaste_interface__calcium_dynamics__R_prime;
        const double var_x254 = var_x240 * var_x243 * var_x247 * var_chaste_interface__calcium_dynamics__Ca_ss;
        const double var_x255 = var_x241 * var_x242 * var_x247;
        const double var_x256 = var_x58 * NV_Ith_S(mParameters, 6);
        const double var_x257 = 0.054494105879490481 * var_x256;
        const double var_x258 = 0.00025000000000000001 + var_chaste_interface__calcium_dynamics__Ca_ss;
        const double var_x259 = 1.0 + 0.0001 / pow(var_x258, 2);
        const double var_x260 = 1 / var_x259;
        const double var_x261 = var_x260;
        const double var_x262 = var_x257 * var_x260 * var_x55;
        const double var_x263 = var_x262 * var_x79;
        const double var_x264 = 0.30611192392099484 * var_x244;
        const double var_x265 = -0.11249999999999999 + 0.067500000000000004 * var_x239;
        const double var_x266 = 0.0093748487085100543 * var_x21 * var_x75 * NV_Ith_S(mParameters, 6);
        const double var_x267 = 0.00034149519658644594 * var_x40;
        const double var_x268 = 4.1599053758030084e-5 * NV_Ith_S(mParameters, 6);
        const double var_x269 = 0.00063181349969740233 * NV_Ith_S(mParameters, 6);
        ...
        IJth(rJacobian, 6, 0) = (var_x156 - var_chaste_interface__fast_sodium_current_h_gate__h) * (((var_x158) ? (-0.008382352941176471 * var_x157) : (0)) + ((var_x158) ? (108035.0 * var_x159 + 0.21330000000000002 * var_x160) : (0.53361053361053368 * var_x161 / pow(var_x162, 2)))) - var_x165 * (var_x163 + var_x164);
        IJth(rJacobian, 7, 0) = (var_x156 - var_chaste_interface__fast_sodium_current_j_gate__j) * (((var_x158) ? (-0.00025500480000000003 * var_x169 + 0.0033402720000000005 * var_x166 * var_x168 / pow(var_x167, 2)) : (0.034200000000000001 * var_x173 + 0.059999999999999998 * var_x170 * var_x172 / pow(var_x171, 2))) + ((var_x158) ? (var_x180 + var_x176 * var_x181 * (3.0508668000000001e-7 * var_x178 - 6214.6032000000005 * var_x177) - 0.311 * var_x174 * var_x179 * var_x181 / pow(var_x175, 2)) : (0))) - var_x165 * (var_x182 + var_x183);
        IJth(rJacobian, 8, 0) = 0.51020408163265307 * (-var_chaste_interface__L_type_Ca_current_d_gate__d + 1 / var_x195) * (-0.050000000000000003 * var_x184 / pow(var_x185, 2) + 0.27999999999999997 * var_x187 * var_x192 / pow(var_x188, 2) - 0.15076923076923074 * var_x189 * var_x190 / pow(var_x191, 2)) / pow((var_x193 + 0.7142857142857143 * var_x186), 2) + 0.13333333333333333 * var_x194 * var_x196 / pow(var_x195, 2);
        IJth(rJacobian, 9, 0) = 8.2270247479188195e-7 * (-var_chaste_interface__L_type_Ca_current_f_gate__f + 1 / var_x206) * (18.0 * var_x207 - var_x208 * (-0.23999999999999999 - 0.0088888888888888889 * var_chaste_interface__membrane__V) - 20.0 * var_x200 / pow(var_x201, 2)) / pow((0.018140589569160998 + var_x204 + 0.16326530612244897 * var_x199 + 0.18140589569160998 * var_x202), 2) - 0.14285714285714285 * var_x205 * var_x209 / pow(var_x206, 2);
        IJth(rJacobian, 10, 0) = 3.1661199832828864e-6 * (0.33000000000000002 - var_chaste_interface__L_type_Ca_current_f2_gate__f2 + 0.67000000000000004 / var_x215) * (8.0 * var_x207 - var_x216 * (-0.22500000000000001 - 0.0083333333333333332 * var_chaste_interface__membrane__V) - 3.1000000000000001 * var_x210 / pow(var_x211, 2)) / pow((var_x213 + 0.055160142348754451 * var_x212 + 0.14234875444839859 * var_x199), 2) - 0.095714285714285724 * var_x214 * var_x217 / pow(var_x215, 2);
        IJth(rJacobian, 12, 0) = 0.00013840830449826991 * (-var_chaste_interface__transient_outward_current_s_gate__s + 1 / var_x227) * (-var_x228 * (-0.28125 - 0.0062500000000000003 * var_chaste_interface__membrane__V) + var_x222 / pow(var_x223, 2)) / pow((0.035294117647058823 + var_x225 + 0.058823529411764705 * var_x224), 2) - 0.20000000000000001 * var_x226 * var_x229 / pow(var_x227, 2);
        IJth(rJacobian, 13, 0) = 0.16666666666666666 * var_x230 * var_x233 / pow(var_x231, 2) - 0.10526315789473684 * var_x232 * (-0.044444444444444446 - 0.0011111111111111111 * var_chaste_interface__membrane__V) * (-var_chaste_interface__transient_outward_current_r_gate__r + 1 / var_x231) / pow((0.084210526315789472 + var_x232), 2);
        IJth(rJacobian, 15, 0) = var_x261 * (-var_x257 * var_x56 + 0.0040798528199519572 * var_x256 * var_x62 - 0.0010199632049879893 * var_x64 * NV_Ith_S(mParameters, 6));
        ...
        IJth(rJacobian, 18, 0) = (0.0034421199463514477 * var_x52 + 2.0489711795186757e-5 * var_x27 - 0.00034149519658644594 * var_x18 - 0.0002476708918813817 * var_x3 - 9.2244770955820725e-6 * var_x2 - 4.1599053758030084e-5 * var_x99 - 0.00018575316891103626 * var_x19 - 1.5425546982578716e-6 * var_x24 - var_x267 * var_x39) * NV_Ith_S(mParameters, 6);
        ...
        IJth(rJacobian, 14, 1) = var_x237 * (0.00036000000000000002 + 7.96875e-10 * var_x106);
        IJth(rJacobian, 15, 1) = 1.1399999999999999 * var_x260;
        ...
        IJth(rJacobian, 17, 6) = -var_x266 * var_chaste_interface__fast_sodium_current_j_gate__j;
        ...
        IJth(rJacobian, 17, 7) = -var_x266 * var_chaste_interface__fast_sodium_current_h_gate__h;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x61 * var_x78);
        IJth(rJacobian, 8, 8) = -var_x196;
        IJth(rJacobian, 15, 8) = -var_x262 * var_x61;
        ...
        IJth(rJacobian, 15, 9) = -var_x263 * var_chaste_interface__L_type_Ca_current_f2_gate__f2;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x80 * var_chaste_interface__L_type_Ca_current_f_gate__f);
        IJth(rJacobian, 10, 10) = -var_x217;
        IJth(rJacobian, 15, 10) = -var_x263 * var_chaste_interface__L_type_Ca_current_f_gate__f;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x78 * var_x81);
        IJth(rJacobian, 11, 11) = -var_x220;
        IJth(rJacobian, 15, 11) = -var_x262 * var_x81;
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x83);
        IJth(rJacobian, 12, 12) = -var_x229;
        IJth(rJacobian, 18, 12) = var_x269 * var_x83;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x84);
        IJth(rJacobian, 13, 13) = -var_x233;
        IJth(rJacobian, 18, 13) = var_x269 * var_x84;
        IJth(rJacobian, 1, 14) = 2.40087783467447e-5 * var_x103;
        IJth(rJacobian, 14, 14) = var_x237 * (-0.00036000000000000002 - var_x245 + 0.021759999999999998 * var_x252 - 0.0032639999999999995 * var_x249) + 0.66666666666666674 * (0.00036000000000000002 * var_chaste_interface__calcium_dynamics__Ca_i + 0.0063749999999999996 * var_x107 - 0.00036000000000000002 * var_chaste_interface__calcium_dynamics__Ca_SR - var_x245 * var_x247) / (pow(var_x234, 3) * pow((0.33333333333333337 + var_x235), 2));
        IJth(rJacobian, 15, 14) = var_x261 * (var_x264 + 0.065303877103145572 * var_x249 - 0.43535918068763713 * var_x252);
        IJth(rJacobian, 16, 14) = 0.059999999999999998 * var_x250 * var_chaste_interface__calcium_dynamics__Ca_ss;
        IJth(rJacobian, 0, 15) = mSetVoltageDerivativeToZero ? 0.0 : (-0.14375050524031124 * var_x85);
        IJth(rJacobian, 1, 15) = 0.0038 * var_x103;
        IJth(rJacobian, 11, 15) = -0.0030000000000000001 * var_x220 * var_x221 + 6.2500000000000001e-5 * var_x221 * (0.40000000000000002 - var_chaste_interface__L_type_Ca_current_fCass_gate__fCass + 0.59999999999999998 * var_x219) / pow((0.025000000000000001 + var_x219), 2);
        IJth(rJacobian, 14, 15) = var_x237 * (var_x245 + 0.032639999999999995 * var_x253 - 0.030599999999999995 * var_x254);
        IJth(rJacobian, 15, 15) = var_x261 * (-1.1399999999999999 - var_x264 + 0.61222384784198969 * var_x254 - 0.65303877103145569 * var_x253 - 0.01362352646987262 * var_x85 * NV_Ith_S(mParameters, 6)) + 0.00020000000000000001 * (1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_i - 1.1399999999999999 * var_chaste_interface__calcium_dynamics__Ca_ss + var_x247 * var_x264 - var_x257 * var_x63) / (pow(var_x258, 3) * pow(var_x259, 2));
        IJth(rJacobian, 16, 15) = var_x265 * var_chaste_interface__calcium_dynamics__R_prime;
        IJth(rJacobian, 14, 16) = -0.015299999999999998 * var_x236 * var_x255;
        IJth(rJacobian, 15, 16) = 0.30611192392099484 * var_x255 * var_x260;
        ...
        IJth(rJacobian, 18, 18) = (0.00054735725688276197 * var_x98 - 0.00024642047334222399 * var_x93 - 0.0049621656960694418 * var_x97 - 0.0011112671657618285 * var_x100 - 0.009122620948046032 * var_x94 - 0.0066162209280925897 * var_x86 - var_x267 * var_x96) * NV_Ith_S(mParameters, 6);
    }
