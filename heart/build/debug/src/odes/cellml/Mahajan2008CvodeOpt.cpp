...
#include "MathsCustomFunctions.hpp"
    ...
    void CellMahajan2008FromCellMLCvodeOpt::EvaluateYDerivatives(double var_chaste_interface__Environment__time, const N_Vector rY, N_Vector rDY)
    {
        ...
        const double var_INaK__xiNaK = 1.5 * NV_Ith_S(mParameters, 4) * var_chaste_interface__Na__Na_i / ((1.5 + NV_Ith_S(mParameters, 4)) * (12.0 + var_chaste_interface__Na__Na_i) * (1.0 + 0.1245 * exp(-0.0037676968035880187 * var_chaste_interface__cell__V) + 0.036499999999999998 * (-0.14285714285714285 + 0.14285714285714285 * exp(0.01485884101040119 * NV_Ith_S(mParameters, 5))) * exp(-0.037676968035880186 * var_chaste_interface__cell__V))); // nA_per_nF
        ...
        const double var_INa__xina = pow(var_chaste_interface__INa__xm, 3) * (-26.541413816729872 * log(NV_Ith_S(mParameters, 5) / var_chaste_interface__Na__Na_i) + var_chaste_interface__cell__V) * NV_Ith_S(mParameters, 7) * var_chaste_interface__INa__xh * var_chaste_interface__INa__xj; // nA_per_nF
    ...
    void CellMahajan2008FromCellMLCvodeOpt::EvaluateAnalyticJacobian(double var_chaste_interface__Environment__time, N_Vector rY, N_Vector rDY, CHASTE_CVODE_DENSE_MATRIX rJacobian, N_Vector rTmp1, N_Vector rTmp2, N_Vector rTmp3)
    {
        double var_chaste_interface__cell__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : NV_Ith_S(rY, 0));
        // Units: mV; Initial value: -87.169816169406
        double var_chaste_interface__Ca__Ca_i_converted = NV_Ith_S(rY, 1);
        ...
        const double var_x112 = 0.012999999999999999 + var_chaste_interface__Ca__Ca_i_converted;
        const double var_x113 = 0.00059999999999999995 + var_chaste_interface__Ca__Ca_i_converted;
        const double var_x114 = 0.00029999999999999997 + var_chaste_interface__Ca__Ca_i_converted;
        const double var_x115 = 0.0070000000000000001 + var_chaste_interface__Ca__Ca_i_converted;
        const double var_x116 = 1.0 + 0.00054600000000000004 / pow(var_x112, 2) + 2.8200000000000001e-5 / pow(var_x113, 2) + 4.5000000000000001e-6 / pow(var_x114, 2) + 0.00016800000000000002 / pow(var_x115, 2);
        ...
        const double var_x126 = 1.0 - var_chaste_interface__INa__xm;
        const double var_x127 = -0.10000000000000001 * var_chaste_interface__cell__V;
        const double var_x128 = exp(-4.7130000000000001 + var_x127);
        const double var_x129 = 1.0 - var_x128;
        const double var_x130 = 0.32000000000000001 / var_x129;
        const double var_x131 = exp(-0.090909090909090912 * var_chaste_interface__cell__V);
        const double var_x132 = 0.0072727272727272727 * var_x131 * var_chaste_interface__INa__xm;
        const double var_x133 = 47.130000000000003 + var_chaste_interface__cell__V;
        const double var_x134 = fabs(var_x133) > 0.001;
        const double var_x135 = -0.080000000000000002 * var_x131;
        const double var_x136 = exp(0.079000000000000001 * var_chaste_interface__cell__V);
        const double var_x137 = exp(0.34999999999999998 * var_chaste_interface__cell__V);
        const double var_x138 = exp(-11.764705882352942 - 0.14705882352941177 * var_chaste_interface__cell__V);
        const double var_x139 = var_chaste_interface__cell__V < -40.0;
        const double var_x140 = exp(-0.96036036036036043 - 0.0900900900900901 * var_chaste_interface__cell__V);
        const double var_x141 = 1.0 + var_x140;
        const double var_x142 = 1.0 - var_chaste_interface__INa__xj;
        const double var_x143 = exp(0.24440000000000001 * var_chaste_interface__cell__V);
        const double var_x144 = exp(-0.043909999999999998 * var_chaste_interface__cell__V);
        const double var_x145 = -127140.0 * var_x143 - 3.4740000000000003e-5 * var_x144;
        ...
        const double var_x150 = exp(-5.5312920000000005 - 0.13780000000000001 * var_chaste_interface__cell__V);
        const double var_x151 = 1.0 + var_x150;
        const double var_x152 = exp(-0.01052 * var_chaste_interface__cell__V);
        ...
        const double var_x156 = exp(-3.2000000000000002 + var_x127);
        const double var_x157 = 1.0 + var_x156;
        const double var_x158 = exp(-2.5349999999999999e-7 * var_chaste_interface__cell__V);
        const double var_x159 = var_x158 / var_x157;
        const double var_x160 = exp(-0.125 * var_chaste_interface__cell__V);
        const double var_x161 = 1.0 + var_x160;
        const double var_x162 = var_x160 / pow(var_x161, 2);
        const double var_x163 = 0.125 * var_x162;
        const double var_x164 = var_x163 * var_chaste_interface__ICaL__c1;
        const double var_x165 = 1 / var_x161;
        const double var_x166 = var_x165;
        const double var_x167 = pow(var_chaste_interface__Ca__Ca_dyad, 3);
        const double var_x168 = 1 / var_x167;
        const double var_x169 = 1 / (1.0 + 27.0 * var_x168);
        const double var_x170 = pow(var_chaste_interface__Ca__Ca_dyad, 4);
        const double var_x171 = 1 / var_x170;
        const double var_x172 = var_x171 / pow((0.037037037037037035 + var_x168), 2);
        const double var_x173 = 0.002685333333333333 * var_x172 * var_chaste_interface__ICaL__c1;
        const double var_x174 = exp(-10.0 - 0.25 * var_chaste_interface__cell__V);
        const double var_x175 = 1.0 + var_x174;
        const double var_x176 = 1.0 - 1.0 / var_x175;
        const double var_x177 = exp(0.064102564102564111 * var_chaste_interface__cell__V);
        const double var_x178 = 4954.0 * var_x177;
        const double var_x179 = -440.0 + var_x178;
        const double var_x180 = var_x176 * var_x179;
        const double var_x181 = 1 / (450.0 + var_x180);
        const double var_x182 = exp(-3.5335689045936394 - 0.088339222614840993 * var_chaste_interface__cell__V);
        const double var_x183 = 1.0 + var_x182;
        const double var_x184 = 0.088339222614840993 * var_x182 / pow(var_x183, 2);
        const double var_x185 = var_x181 * var_x184;
        const double var_x186 = 1 / var_x183;
        const double var_x187 = -317.5641025641026 * var_x176 * var_x177;
        const double var_x188 = 0.25 * var_x174 / pow(var_x175, 2);
        const double var_x189 = 4.9382716049382717e-6 * (var_x187 + var_x179 * var_x188) / pow((1 + 0.0022222222222222222 * var_x180), 2);
        const double var_x190 = var_x186 * var_x189;
        const double var_x191 = 1.0 + 0.00072525373756441506 * var_x170;
        const double var_x192 = 1 / var_x191;
        const double var_x193 = 78.032899999999998 * var_x192;
        const double var_x194 = 9.9000000000000004 + var_x178 - var_x193;
        const double var_x195 = var_x176 * var_x194;
        const double var_x196 = 1 / (0.10000000000000001 + var_x193 + var_x195);
        const double var_x197 = var_x169 * var_x196;
        const double var_x198 = var_x184 * var_x197;
        const double var_x199 = 0.00016422697956757767 / pow((0.0012815107473898831 + var_x192 + 0.012815107473898831 * var_x195), 2);
        const double var_x200 = var_x199 * (var_x187 + var_x188 * var_x194);
        const double var_x201 = var_x169 * var_x186;
        const double var_x202 = var_x200 * var_x201;
        const double var_x203 = var_x186;
        const double var_x204 = 1.0 - var_x203;
        const double var_x205 = var_x189 * var_x204;
        const double var_x206 = var_x200 * var_x204;
        const double var_x207 = var_x184 * var_x196;
        const double var_x208 = -var_x166;
        const double var_x209 = 1.0 + var_x208;
        const double var_x210 = var_x181 * var_x203;
        const double var_x211 = var_x197 * var_x203;
        const double var_x212 = var_x196 * var_x204;
        const double var_x213 = var_x181 * var_x204;
        const double var_x214 = 0.22637460951196098 * var_x167 / pow(var_x191, 2);
        const double var_x215 = var_x199 * (var_x214 - var_x176 * var_x214);
        const double var_x216 = var_x201 * var_x215;
        const double var_x217 = 0.1111111111111111 * var_x172 * var_x186 * var_x196;
        const double var_x218 = var_x204 * var_chaste_interface__ICaL__xi2ca;
        const double var_x219 = var_x215 * var_x218;
        const double var_x220 = exp(-13.333333333333334 - 0.33333333333333331 * var_chaste_interface__cell__V);
        const double var_x221 = 1.0 + var_x220;
        const double var_x222 = var_x220 / pow(var_x221, 2);
        const double var_x223 = 0.1111111111111111 * var_x222;
        const double var_x224 = var_x223 * var_chaste_interface__ICaL__xi1ca;
        const double var_x225 = 0.33333333333333331 / var_x221;
        const double var_x226 = 0.33333333333333331 - var_x225;
        const double var_x227 = 1 / var_x209;
        const double var_x228 = var_x165 * var_x227;
        const double var_x229 = var_x182 * var_x226 * var_x228;
        const double var_x230 = 20.604954226274931 * var_x229;
        const double var_x231 = var_x186 * var_x230;
        const double var_x232 = var_x162 * var_x227;
        const double var_x233 = var_x183 * var_x226;
        const double var_x234 = 29.156010230179024 * var_x218 * var_x233;
        const double var_x235 = var_x160 / (pow(var_x161, 3) * pow(var_x209, 2));
        const double var_x236 = -0.018268800000000002 * var_x169;
        const double var_x237 = 41.377027474346242 + 1117.1797418073486 * var_x168;
        const double var_x238 = var_x204 * var_x233;
        const double var_x239 = var_x228 * var_x238;
        const double var_x240 = 233.2480818414322 * var_x239;
        const double var_x241 = 1.0 - var_chaste_interface__ICaL__c1 - var_chaste_interface__ICaL__c2 - var_chaste_interface__ICaL__xi1ba - var_chaste_interface__ICaL__xi1ca - var_chaste_interface__ICaL__xi2ba - var_chaste_interface__ICaL__xi2ca;
        const double var_x242 = var_x223 * var_chaste_interface__ICaL__xi1ba;
        const double var_x243 = 0.16287544169611309 * var_x229;
        const double var_x244 = var_x186 * var_x243;
        const double var_x245 = var_x204 * var_x243;
        const double var_x246 = 0.23046875000000003 * var_x238;
        const double var_x247 = var_x232 * var_x246;
        const double var_x248 = var_x235 * var_x246;
        const double var_x249 = var_x183 * var_x204 * var_x222 * var_x228;
        const double var_x250 = 0.20486111111111113 * var_x249;
        const double var_x251 = 1.8437500000000002 * var_x239;
        const double var_x252 = 29.156010230179024 * var_x238;
        const double var_x253 = exp(-6.666666666666667 - 0.13333333333333333 * var_chaste_interface__cell__V);
        const double var_x254 = 1.0 + var_x253;
        const double var_x255 = -var_chaste_interface__IKr__xr + 1 / var_x254;
        const double var_x256 = exp(1.45 + 0.14499999999999999 * var_chaste_interface__cell__V);
        const double var_x257 = -1.0 + var_x256;
        const double var_x258 = 0.00060999999999999997 / var_x257;
        const double var_x259 = 10.0 + var_chaste_interface__cell__V;
        const double var_x260 = var_x258 - 8.8449999999999995e-5 * var_x256 * var_x259 / pow(var_x257, 2);
        const double var_x261 = exp(-0.86099999999999999 - 0.123 * var_chaste_interface__cell__V);
        const double var_x262 = 1.0 - var_x261;
        const double var_x263 = 0.0013799999999999999 / var_x262;
        const double var_x264 = 7.0 + var_chaste_interface__cell__V;
        const double var_x265 = var_x263 - 0.00016973999999999998 * var_x261 * var_x264 / pow(var_x262, 2);
        const double var_x266 = var_x258 * var_x259;
        const double var_x267 = var_x263 * var_x264;
        const double var_x268 = var_x253 / pow(var_x254, 2);
        const double var_x269 = 0.13333333333333333 * var_x268;
        const double var_x270 = fabs(var_x264) > 0.001;
        const double var_x271 = fabs(var_x259) > 0.001;
        const double var_x272 = (var_x270) && (var_x271);
        const double var_x273 = -var_x266;
        const double var_x274 = -var_x267;
        ...
        const double var_x278 = 30.0 + var_chaste_interface__cell__V;
        const double var_x279 = fabs(var_x278) < 0.014556040756914121;
        ...
        const double var_x286 = ((var_x279) ? (0) : (var_x282 + var_x285 - 8.9997000000000013e-6 * var_x278 * var_x280 / pow(var_x281, 2) - 1.0641199999999999e-5 * var_x278 * var_x283 / pow(var_x284, 2)));
        const double var_x287 = ((var_x279) ? (0.0023926521499665608) : (var_x278 * var_x282 + var_x278 * var_x285));
        const double var_x288 = var_x275 * var_x287 / pow(var_x276, 2);
        ...
        const double var_x298 = exp(6.0 + var_x0);
        const double var_x299 = 1.0 + var_x298;
        const double var_x300 = 1 / var_x299;
        const double var_x301 = 1 / (30.0 + 3000.0 * var_x300);
        const double var_x302 = 0.10000000000000001 * var_x59;
        const double var_x303 = var_x3;
        const double var_x304 = exp(-0.0011111111111111111 * pow(var_chaste_interface__cell__V, 2));
        const double var_x305 = 1 / (1.5 + 3.5 * var_x304);
        const double var_x306 = 1 / (20.0 + 20.0 * var_x3);
        const double var_x307 = exp(-1.5 - 0.050000000000000003 * var_chaste_interface__cell__V);
        const double var_x308 = 1.0 + var_x307;
        const double var_x309 = fabs(var_x84);
        const double var_x310 = 0.011111111111111112 * var_chaste_interface__Ca__Ca_NSR;
        const double var_x311 = (var_chaste_interface__Irel__Ca_JSR > 50.0) && (var_chaste_interface__Irel__Ca_JSR < 90.0);
        const double var_x312 = var_chaste_interface__Irel__Ca_JSR >= 90.0;
        const double var_x313 = ((var_x311) ? (var_x310 * (-50.0 + var_chaste_interface__Irel__Ca_JSR)) : ((var_x312) ? (var_x310 * (-977.00000000000011 + 11.300000000000001 * var_chaste_interface__Irel__Ca_JSR)) : (0)));
        const double var_x314 = var_x309 * var_x313;
        const double var_x315 = 0.1290395 * var_x241;
        const double var_x316 = 1 / var_x308;
        const double var_x317 = var_x307 * var_x314 * var_x316;
        const double var_x318 = 2.5807899999999999 * var_x307 * var_x316;
        const double var_x319 = Signum(var_x84);
        const double var_x320 = var_x241 * var_x313 * var_x319;
        const double var_x321 = var_x318 * var_x320;
        const double var_x322 = var_x109 + var_x111 - var_x105;
        const double var_x323 = 1 / var_chaste_interface__Ca__Ca_NSR;
        const double var_x324 = var_x323 * var_chaste_interface__Irel__xir;
        const double var_x325 = -2.5807899999999999 * var_x317;
        const double var_x326 = var_x241 * var_x309;
        const double var_x327 = var_x326 * ((var_x311) ? (var_x310) : ((var_x312) ? (0.12555555555555556 * var_chaste_interface__Ca__Ca_NSR) : (0)));
        const double var_x328 = var_x120 - var_x122 - var_chaste_interface__Irel__xir;
        const double var_x329 = var_x125 - var_x123 - var_x124;
        const double var_x330 = var_x326 * ((var_x311) ? (-0.55555555555555558 + 0.011111111111111112 * var_chaste_interface__Irel__Ca_JSR) : ((var_x312) ? (-10.855555555555556 + 0.12555555555555556 * var_chaste_interface__Irel__Ca_JSR) : (0)));
        const double var_x331 = 7.2772931878418305e-10 * var_x96;
        const double var_x332 = var_x319 * (9000.0 - 9000.0 * var_chaste_interface__ICaL__c1 - 9000.0 * var_chaste_interface__ICaL__c2 - 9000.0 * var_chaste_interface__ICaL__xi1ba - 9000.0 * var_chaste_interface__ICaL__xi1ca - 9000.0 * var_chaste_interface__ICaL__xi2ba - 9000.0 * var_chaste_interface__ICaL__xi2ca);
        const double var_x333 = exp(-10.728 - 0.35759999999999997 * var_chaste_interface__cell__V);
        const double var_x334 = 1.0 + var_x333;
        const double var_x335 = 9598.6276799999996 * var_x241;
        const double var_x336 = 1 / var_x334;
        const double var_x337 = var_x314 * var_x333 * var_x336;
        const double var_x338 = 26841.799999999999 * var_x333 * var_x336;
        const double var_x339 = var_x320 * var_x338;
        const double var_x340 = -9000.0 * var_x309 - 26841.799999999999 * var_x337;
        const double var_x341 = (-50.0 + 50.0 * var_chaste_interface__ICaL__c1 + 50.0 * var_chaste_interface__ICaL__c2 + 50.0 * var_chaste_interface__ICaL__xi1ba + 50.0 * var_chaste_interface__ICaL__xi1ca + 50.0 * var_chaste_interface__ICaL__xi2ba + 50.0 * var_chaste_interface__ICaL__xi2ca) * NV_Ith_S(mParameters, 6);
        const double var_x342 = 0.29999999999999999 + var_chaste_interface__Ca__Ca_submem;
        const double var_x343 = pow(var_x342, (-2));
        const double var_x344 = 1 + 0.076923076923076927 * var_chaste_interface__Ca__Ca_submem;
        const double var_x345 = pow(var_x344, (-2));
        const double var_x346 = 0.59999999999999998 + var_chaste_interface__Ca__Ca_submem;
        const double var_x347 = pow(var_x346, (-2));
        const double var_x348 = 1 + 0.14285714285714285 * var_chaste_interface__Ca__Ca_submem;
        const double var_x349 = pow(var_x348, (-2));
        const double var_x350 = 1 / (1.0 + 4.5 * var_x343 + 3.2307692307692308 * var_x345 + 28.199999999999999 * var_x347 + 3.4285714285714284 * var_x349);
        const double var_x351 = var_x350;
        const double var_x352 = 50.0 * var_x350;
        const double var_x353 = var_x352 * var_x85;
        const double var_x354 = 1.2128821979736383e-5 * var_x96;
        const double var_x355 = 0.0327 * var_chaste_interface__Ca__trops;
        const double var_x356 = 0.0327 * var_chaste_interface__Ca__Ca_submem;
        ...
        IJth(rJacobian, 2, 0) = ((var_x134) ? (var_x132 + var_x126 * var_x130 - 0.032000000000000001 * var_x126 * var_x128 * var_x133 / pow(var_x129, 2)) : (var_x132));
        IJth(rJacobian, 3, 0) = ((var_x139) ? ((-0.28123999999999999 * var_x136 - 108500.0 * var_x137) * var_chaste_interface__INa__xh - 0.14705882352941177 * var_x138 * (0.13500000000000001 - 0.13500000000000001 * var_chaste_interface__INa__xh)) : (-0.693000693000693 * var_x140 * var_chaste_interface__INa__xh / pow(var_x141, 2)));
        IJth(rJacobian, 4, 0) = ((var_x139) ? (var_x146 * var_x149 + 0.001275024 * var_x153 * var_chaste_interface__INa__xj + var_x142 * var_x155 * (1.5254334000000001e-6 * var_x144 - 31073.016 * var_x143) - 0.311 * var_x146 * var_x147 * var_x154 / pow(var_x148, 2) - 0.016701360000000002 * var_x150 * var_x152 * var_chaste_interface__INa__xj / pow(var_x151, 2)) : (7.6049999999999996e-8 * var_x159 * var_chaste_interface__INa__xj - 0.029999999999999999 * var_x156 * var_x158 * var_chaste_interface__INa__xj / pow(var_x157, 2)));
        IJth(rJacobian, 5, 0) = var_x164 + var_x163 * var_chaste_interface__ICaL__c2;
        IJth(rJacobian, 6, 0) = -var_x164 + var_x205 * var_chaste_interface__ICaL__xi2ba + var_x206 * var_chaste_interface__ICaL__xi2ca + (-var_x163 - var_x185 - var_x190 - var_x198 - var_x202) * var_chaste_interface__ICaL__c2 - var_x185 * var_chaste_interface__ICaL__xi2ba - var_x207 * var_chaste_interface__ICaL__xi2ca;
        IJth(rJacobian, 7, 0) = var_x224 + var_x232 * var_x234 + var_x234 * var_x235 - var_x218 * var_x230 - var_x231 * var_chaste_interface__ICaL__xi2ca - 25.91645353793691 * var_x183 * var_x218 * var_x222 * var_x228;
        IJth(rJacobian, 8, 0) = var_x242 + var_x247 * var_chaste_interface__ICaL__xi2ba + var_x248 * var_chaste_interface__ICaL__xi2ba - var_x244 * var_chaste_interface__ICaL__xi2ba - var_x245 * var_chaste_interface__ICaL__xi2ba - var_x250 * var_chaste_interface__ICaL__xi2ba;
        IJth(rJacobian, 9, 0) = -var_x224 + var_x198 * var_chaste_interface__ICaL__c2 + var_x202 * var_chaste_interface__ICaL__c2 + (var_x207 + var_x231 - var_x206 + 25.91645353793691 * var_x249 + var_x204 * var_x230 - var_x232 * var_x252 - var_x235 * var_x252) * var_chaste_interface__ICaL__xi2ca;
        IJth(rJacobian, 10, 0) = -var_x242 + var_x185 * var_chaste_interface__ICaL__c2 + var_x190 * var_chaste_interface__ICaL__c2 + (var_x185 + var_x244 + var_x245 + var_x250 - var_x205 - var_x247 - var_x248) * var_chaste_interface__ICaL__xi2ba;
        IJth(rJacobian, 11, 0) = ((var_x272) ? (var_x255 * (var_x260 + var_x265) + var_x269 * (var_x266 + var_x267)) : ((var_x271) ? (var_x255 * var_x260 + var_x269 * (0.011219512195121951 + var_x266)) : ((var_x270) ? (var_x255 * var_x265 + var_x269 * (0.0042068965517241376 + var_x267)) : (0.0020568544995794784 * var_x268))));
        IJth(rJacobian, 12, 0) = 0.059880239520958084 * var_x288 + var_x286 * (-var_chaste_interface__IKs__xs1 + var_x277);
        IJth(rJacobian, 13, 0) = 0.014970059880239521 * var_x288 + var_x286 * (0.25 * var_x277 - 0.25 * var_chaste_interface__IKs__xs2);
        IJth(rJacobian, 14, 0) = var_x293 * var_x296 + 0.0074074074074074077 * var_x290 * (var_x297 - var_chaste_interface__Ito__xtos) / (pow(var_x291, 2) * pow((0.055555555555555552 + var_x292), 2));
        IJth(rJacobian, 15, 0) = -var_x301 * var_x302 + 3.3333333333333335e-5 * var_x298 * (var_x303 - var_chaste_interface__Ito__ytos) / (pow(var_x299, 2) * pow((0.01 + var_x300), 2));
        IJth(rJacobian, 16, 0) = var_x296 * var_x305 + 0.00063492063492063492 * var_x304 * (var_x297 - var_chaste_interface__Ito__xtof) * var_chaste_interface__cell__V / pow((0.42857142857142855 + var_x304), 2);
        IJth(rJacobian, 17, 0) = -var_x302 * var_x306 + 0.0050000000000000001 * var_x59 * (var_x303 - var_chaste_interface__Ito__ytof) / pow((1 + var_x3), 2);
        IJth(rJacobian, 19, 0) = var_x14 * var_x321 - var_x315 * var_x317 + var_x314 * var_x315 * pow(var_x307, 2) / pow(var_x308, 2);
        ...
        IJth(rJacobian, 21, 0) = var_x14 * var_x332 + var_x14 * var_x339 - var_x335 * var_x337 + var_x314 * var_x335 * pow(var_x333, 2) / pow(var_x334, 2);
        IJth(rJacobian, 22, 0) = var_x351 * (42.0 * var_x55 + 0.20571624547590581 * var_x66 + var_x14 * var_x341);
        ...
        IJth(rJacobian, 1, 1) = var_x118 * (-2539.0 + var_x103 + var_x105 - var_x109 - var_x111) + 0.001 * (0.0010920000000000001 / pow(var_x112, 3) + 5.6400000000000002e-5 / pow(var_x113, 3) + 9.0000000000000002e-6 / pow(var_x114, 3) + 0.00033600000000000004 / pow(var_x115, 3)) * (var_x122 - var_x120 + 0.25 * var_chaste_interface__Ca__Ca_submem + 0.019599999999999999 * var_chaste_interface__Ca__tropi - 250.0 * var_chaste_interface__Ca__Ca_i_converted - var_x119 * (70.0 - var_chaste_interface__Ca__tropi)) / pow(var_x116, 2);
        IJth(rJacobian, 19, 1) = var_x322 * var_x324;
        IJth(rJacobian, 22, 1) = 12500.0 * var_x350;
        IJth(rJacobian, 23, 1) = var_x322;
        IJth(rJacobian, 24, 1) = 2289.0 - var_x103;
        IJth(rJacobian, 0, 2) = mSetVoltageDerivativeToZero ? 0.0 : (-3 * var_x80);
        IJth(rJacobian, 2, 2) = ((var_x134) ? (var_x135 - var_x130 * var_x133) : (-3.2000000000000002 + var_x135));
        IJth(rJacobian, 20, 2) = -0.00037500000000000001 * var_x80;
        IJth(rJacobian, 0, 3) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x81);
        IJth(rJacobian, 3, 3) = ((var_x139) ? (-310000.0 * var_x137 - 0.13500000000000001 * var_x138 - 3.5600000000000001 * var_x136) : (-7.6923076923076916 / var_x141));
        IJth(rJacobian, 20, 3) = -0.000125 * var_x81;
        IJth(rJacobian, 0, 4) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x82);
        IJth(rJacobian, 4, 4) = ((var_x139) ? (-0.1212 * var_x153 - var_x145 * var_x155) : (-0.29999999999999999 * var_x159));
        IJth(rJacobian, 20, 4) = -0.000125 * var_x82;
        IJth(rJacobian, 0, 5) = mSetVoltageDerivativeToZero ? 0.0 : (var_x86);
        IJth(rJacobian, 5, 5) = -4.3041299999999998 + var_x166 - 0.024167999999999999 * var_x169;
        IJth(rJacobian, 6, 5) = var_x209;
        IJth(rJacobian, 7, 5) = 0.0058991999999999968 * var_x169;
        IJth(rJacobian, 8, 5) = 0.0021800000000000001;
        IJth(rJacobian, 19, 5) = var_x325;
        IJth(rJacobian, 21, 5) = var_x340;
        IJth(rJacobian, 22, 5) = var_x353;
        IJth(rJacobian, 0, 6) = mSetVoltageDerivativeToZero ? 0.0 : (var_x86);
        IJth(rJacobian, 5, 6) = -3.0 + var_x166;
        IJth(rJacobian, 6, 6) = var_x208 - var_x210 - var_x211;
        IJth(rJacobian, 7, 6) = var_x236;
        IJth(rJacobian, 8, 6) = -0.0019499999999999999;
        IJth(rJacobian, 9, 6) = var_x211;
        IJth(rJacobian, 10, 6) = var_x210;
        IJth(rJacobian, 19, 6) = var_x325;
        IJth(rJacobian, 21, 6) = var_x340;
        IJth(rJacobian, 22, 6) = var_x353;
        IJth(rJacobian, 0, 7) = mSetVoltageDerivativeToZero ? 0.0 : (var_x86);
        IJth(rJacobian, 5, 7) = -2.999896385;
        IJth(rJacobian, 7, 7) = -0.33343694833333332 + var_x225 + var_x236 - 1.8929217120000003e-7 * var_x169 * var_x237;
        IJth(rJacobian, 8, 7) = -0.0019499999999999999;
        IJth(rJacobian, 9, 7) = var_x226;
        IJth(rJacobian, 19, 7) = var_x325;
        IJth(rJacobian, 21, 7) = var_x340;
        IJth(rJacobian, 22, 7) = var_x353;
        IJth(rJacobian, 0, 8) = mSetVoltageDerivativeToZero ? 0.0 : (var_x86);
        IJth(rJacobian, 5, 8) = -2.99776;
        IJth(rJacobian, 7, 8) = var_x236;
        IJth(rJacobian, 8, 8) = -0.33762909604519775 + var_x225;
        IJth(rJacobian, 10, 8) = var_x226;
        IJth(rJacobian, 19, 8) = var_x325;
        IJth(rJacobian, 21, 8) = var_x340;
        IJth(rJacobian, 22, 8) = var_x353;
        IJth(rJacobian, 0, 9) = mSetVoltageDerivativeToZero ? 0.0 : (var_x86);
        IJth(rJacobian, 5, 9) = -3.0;
        IJth(rJacobian, 6, 9) = var_x212;
        IJth(rJacobian, 7, 9) = var_x236 + var_x240;
        IJth(rJacobian, 8, 9) = -0.0019499999999999999;
        IJth(rJacobian, 9, 9) = -var_x212 - var_x240;
        IJth(rJacobian, 19, 9) = var_x325;
        IJth(rJacobian, 21, 9) = var_x340;
        IJth(rJacobian, 22, 9) = var_x353;
        IJth(rJacobian, 0, 10) = mSetVoltageDerivativeToZero ? 0.0 : (var_x86);
        IJth(rJacobian, 5, 10) = -3.0;
        IJth(rJacobian, 6, 10) = var_x213;
        IJth(rJacobian, 7, 10) = var_x236;
        IJth(rJacobian, 8, 10) = -0.0019499999999999999 + var_x251;
        IJth(rJacobian, 10, 10) = -var_x213 - var_x251;
        IJth(rJacobian, 19, 10) = var_x325;
        IJth(rJacobian, 21, 10) = var_x340;
        IJth(rJacobian, 22, 10) = var_x353;
        IJth(rJacobian, 0, 11) = mSetVoltageDerivativeToZero ? 0.0 : (-var_x63 * var_x64 * NV_Ith_S(mParameters, 0) * NV_Ith_S(mParameters, 8));
        IJth(rJacobian, 11, 11) = ((var_x272) ? (var_x273 + var_x274) : ((var_x271) ? (-0.011219512195121951 + var_x273) : ((var_x270) ? (-0.0042068965517241376 + var_x274) : (-0.015426408746846089))));
        IJth(rJacobian, 0, 12) = mSetVoltageDerivativeToZero ? 0.0 : (var_x32 * var_x75);
        IJth(rJacobian, 12, 12) = -var_x287;
        IJth(rJacobian, 0, 13) = mSetVoltageDerivativeToZero ? 0.0 : (var_x31 * var_x76);
        IJth(rJacobian, 13, 13) = -0.25 * var_x287;
        IJth(rJacobian, 0, 14) = mSetVoltageDerivativeToZero ? 0.0 : (var_x4 * var_x56);
        IJth(rJacobian, 14, 14) = -var_x293;
        ...
        IJth(rJacobian, 15, 15) = -var_x301;
        IJth(rJacobian, 0, 16) = mSetVoltageDerivativeToZero ? 0.0 : (var_x87 * var_chaste_interface__Ito__ytof);
        IJth(rJacobian, 16, 16) = -var_x305;
        IJth(rJacobian, 0, 17) = mSetVoltageDerivativeToZero ? 0.0 : (var_x87 * var_chaste_interface__Ito__xtof);
        IJth(rJacobian, 17, 17) = -var_x306;
        IJth(rJacobian, 18, 18) = -0.01;
        IJth(rJacobian, 19, 18) = var_x318 * var_x327;
        IJth(rJacobian, 21, 18) = var_x327 * var_x338;
        IJth(rJacobian, 19, 19) = -0.033333333333333333 - var_x324 + var_x323 * var_x328;
        ...
        IJth(rJacobian, 20, 20) = 3.9062500000000001e-6 * var_x90 - 0.0033176767270912339 * var_x91 - 0.00056249999999999996 * var_x89 - 0.0075599999999999999 * var_x98 - var_x331 * var_x94;
        IJth(rJacobian, 22, 20) = var_x351 * (126.0 * var_x98 + var_x354 * var_x94);
        IJth(rJacobian, 5, 21) = -var_x173;
        IJth(rJacobian, 6, 21) = var_x219 + (-var_x216 - var_x217) * var_chaste_interface__ICaL__c2;
        IJth(rJacobian, 7, 21) = var_x173 + (0.00063442013684210537 * var_x169 * var_x171 - 2.1032463466666669e-8 * var_x172 * var_x237) * var_chaste_interface__ICaL__xi1ca + 0.0020298666666666667 * var_x172 * var_x241;
        IJth(rJacobian, 9, 21) = -var_x219 + var_x216 * var_chaste_interface__ICaL__c2 + var_x217 * var_chaste_interface__ICaL__c2;
        ...
        IJth(rJacobian, 19, 22) = var_x321 * var_x99;
        IJth(rJacobian, 20, 22) = 2.52e-6 * var_x100 - 0.00020411999999999996 * var_x102 - var_x101 * var_x331;
        IJth(rJacobian, 21, 22) = 2.0 + var_x332 * var_x99 + var_x339 * var_x99;
        IJth(rJacobian, 22, 22) = var_x351 * (-14.789 + var_x355 + 3.4019999999999997 * var_x102 - 0.041999999999999996 * var_x100 + var_x101 * var_x354 + var_x341 * var_x99) + 0.0012574820180071425 * (9.0 / pow(var_x342, 3) + 56.399999999999999 / pow(var_x346, 3) + 0.97959183673469385 / pow(var_x348, 3) + 0.49704142011834318 / pow(var_x344, 3)) * (50.0 * var_chaste_interface__Irel__xir + 0.019599999999999999 * var_chaste_interface__Ca__trops + 12500.0 * var_chaste_interface__Ca__Ca_i_converted - 12.5 * var_chaste_interface__Ca__Ca_submem - var_x356 * (70.0 - var_chaste_interface__Ca__trops) + 42.0 * var_x54 * var_x65 - 50.0 * var_x241 * var_x85) / pow((0.035460992907801421 + var_x347 + 0.15957446808510639 * var_x343 + 0.12158054711246201 * var_x349 + 0.11456628477905074 * var_x345), 2);
        IJth(rJacobian, 25, 22) = 2.2890000000000001 - var_x355;
        IJth(rJacobian, 1, 23) = var_x118 * (var_x123 + var_x124 - var_x125);
        IJth(rJacobian, 18, 23) = 0.01;
        IJth(rJacobian, 19, 23) = var_x318 * var_x330 + (var_x323 * var_x329 - 1.0 * var_x328 / var_x106) * var_chaste_interface__Irel__xir;
        IJth(rJacobian, 21, 23) = var_x330 * var_x338;
        IJth(rJacobian, 23, 23) = var_x329;
        IJth(rJacobian, 1, 24) = var_x118 * (0.019599999999999999 + var_x119);
        IJth(rJacobian, 24, 24) = -0.019599999999999999 - var_x119;
        IJth(rJacobian, 22, 25) = var_x351 * (0.019599999999999999 + var_x356);
        IJth(rJacobian, 25, 25) = -0.019599999999999999 - var_x356;
    }

    N_Vector CellMahajan2008FromCellMLCvodeOpt::ComputeDerivedQuantities(double var_chaste_interface__Environment__time, const N_Vector & rY)
    {
        // Inputs:
        // Time units: millisecond
        double var_chaste_interface__Ca__Ca_i_converted = NV_Ith_S(rY, 1);
