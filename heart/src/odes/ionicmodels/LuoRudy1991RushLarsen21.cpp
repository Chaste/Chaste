...
#include "MathsCustomFunctions.hpp"
    ...
    boost::shared_ptr<RegularStimulus> CellLuoRudy1991FromCellMLRushLarsen21::UseCellMLDefaultStimulus()
    {
    ...
    double CellLuoRudy1991FromCellMLRushLarsen21::GetIntracellularCalciumConcentration()
    {
        return mStateVariables[7];
    }
    
    CellLuoRudy1991FromCellMLRushLarsen21::CellLuoRudy1991FromCellMLRushLarsen21(boost::shared_ptr<AbstractIvpOdeSolver> /* unused; should be empty */, boost::shared_ptr<AbstractStimulusFunction> pIntracellularStimulus)
                ...
                pIntracellularStimulus)
    {
        ...
        // 
        this->mpSystemInfo = OdeSystemInformation<CellLuoRudy1991FromCellMLRushLarsen21>::Instance();
        Init();
    ...
    CellLuoRudy1991FromCellMLRushLarsen21::~CellLuoRudy1991FromCellMLRushLarsen21()
    {
    }
    
    void CellLuoRudy1991FromCellMLRushLarsen21::VerifyStateVariables()
    {
    ...
    double CellLuoRudy1991FromCellMLRushLarsen21::GetIIonic(const std::vector<double>* pStateVariables)
    {
    ...
    void CellLuoRudy1991FromCellMLRushLarsen21::EvaluateEquations(double var_chaste_interface__environment__time, std::vector<double> &rDY, std::vector<double> &rAlphaOrTau, std::vector<double> &rBetaOrInf)
    {
        std::vector<double>& rY = rGetStateVariables();
        double var_chaste_interface__membrane__V = (mSetVoltageDerivativeToZero ? this->mFixedVoltage : rY[0]);
        // Units: millivolt; Initial value: -83.853
