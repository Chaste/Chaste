...
macro(Chaste_DO_APPS_COMMON component)
    ...
    foreach(app ${Chaste_${component}_APPS})
        ...
        if (BUILD_SHARED_LIBS)
            target_link_libraries(${appName} LINK_PUBLIC chaste_${component} ${Chaste_LIBRARIES})
        else()
            target_link_libraries(${appName} LINK_PUBLIC chaste_${component}  ${Chaste_LIBRARIES} ${Chaste_THIRD_PARTY_LIBRARIES} )
        endif()
        if(MSVC)
