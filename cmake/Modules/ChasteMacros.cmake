...
macro(Chaste_ADD_TEST _testTargetName _filename)
    ...
    if (python)
        ...
        if (NOT TARGET ${exeTargetName})
            ...
            set_property(TARGET ${exeTargetName} PROPERTY CXX_STANDARD 14)
...
macro(Chaste_DO_COMMON component)
    ...
    set_property(TARGET chaste_${component} PROPERTY CXX_STANDARD 14)
...
macro(Chaste_DO_TEST_COMMON component)
    ...
    if(test_sources)
        ...
        set_property(TARGET test${component} PROPERTY CXX_STANDARD 14)
