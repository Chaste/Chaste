...
endmacro()
  ...
  macro(CHASTE_DO_COMMON component)
    ...
    if (NOT (Chaste_LINK_LIBRARIES_WITH_UNRESOLVED_SYMBOLS AND BUILD_SHARED_LIBS))
        target_link_libraries(${component} LINK_PUBLIC ${Chaste_LIBRARIES} ${Chaste_THIRD_PARTY_LIBRARIES})
    endif()
	...
	if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/apps")
        message("Configuring apps for ${component}")
		...
		foreach(app ${CHASTE_${component}_APPS})
            ...
            target_link_libraries(${appName} LINK_PUBLIC ${component} ${CHASTE_DEPENDS_${component}} ${Chaste_THIRD_PARTY_LIBRARIES} ${CHASTE_LINK_LIBRARIES})
            if(MSVC)
        ...
        foreach(type ${TestPackTypes})
            ...
            foreach(filename ${testpack})
                ...
                if (NOT DEFINED ${testTargetName})
                    ...
                    if (BUILD_SHARED_LIBS)
                        if (Chaste_LINK_LIBRARIES_WITH_UNRESOLVED_SYMBOLS)
