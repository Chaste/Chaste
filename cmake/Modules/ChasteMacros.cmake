...
endmacro()
  ...
  macro(CHASTE_DO_COMMON component)
    ...
    if (NOT (Chaste_LINK_LIBRARIES_WITH_UNRESOLVED_SYMBOLS AND BUILD_SHARED_LIBS))
        target_link_libraries(${component} ${Chaste_LIBRARIES} ${Chaste_THIRD_PARTY_LIBRARIES})
    endif()
                ...
                if (NOT DEFINED ${testTargetName})
                    ...
                    if (BUILD_SHARED_LIBS)
                        if (Chaste_LINK_LIBRARIES_WITH_UNRESOLVED_SYMBOLS)
                            target_link_libraries(${exeTargetName} ${COMPONENT_LIBRARIES} ${Chaste_LIBRARIES} ${Chaste_THIRD_PARTY_LIBRARIES} )
                        else()
